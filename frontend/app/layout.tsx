...
export const metadata: Metadata = {
  title: "Jobbaazar - Job Marketplace | Connect Workers with Employers",
  description: "Jobbaazar is a multilingual job marketplace connecting manual labor workers with employers in the UK. Find jobs, post jobs, and connect with the Iranian community and beyond.",
  keywords: "job marketplace, manual labor, UK jobs, Iranian workers, construction jobs, cleaning jobs, delivery jobs, multilingual jobs",
  authors: [{ name: "Jobbaazar Team" }],
  creator: "Jobbaazar",
  publisher: "Jobbaazar",
  formatDetection: {
    email: false,
  ...
  metadataBase: new URL('https://jobbaazar.com'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
    title: "Jobbaazar - Job Marketplace",
    description: "Connect manual labor workers with employers in the UK",
    url: 'https://jobbaazar.com',
    siteName: 'Jobbaazar',
    images: [
      {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Jobbaazar" />
